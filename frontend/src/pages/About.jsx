      ...
      <div className="flex flex-col md:flex-row justify-center gap-10 mt-12">
        ...
        <div className="w-[50%]">
          <p className="leading-6 font-light mb-8 ">
            Welcome to MedifyPro, your trusted partner in managing your
            healthcare needs conveniently and efficiently. At MedifyPro, we
            understand the challenges individuals face when it comes to
            scheduling doctor appointments and managing their health records.
          </p>
          <p className="leading-6 font-light my-8">
            MedifyPro is committed to excellence in healthcare technology. We
            continuously strive to enhance our platform, integrating the latest
            advancements to improve user experience and deliver superior
            service. Whether you're booking your first appointment or managing
            ongoing care, MedifyPro is here to support you every step of the way
          </p>
